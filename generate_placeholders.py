...
CLIPS = [
    ...
    (
        "frodon",
        "je_voudrais_que_cette_nuit",
        "Je voudrais que cette nuit n'ait jamais commencé.",
        80,
        52,
    ),
    ...
    (
        "sam",
        "je_peux_vous_porter",
        "Je ne peux pas porter l'Anneau, mais je peux vous porter !",
        80,
        50,
    ),
...
_MOTIFS: dict[str, list] = {
    ...
    "gollum": _note(293, 0.2)
    + _note(int(293 * 1.06), 0.2)
    + _chord([220, int(330 * 1.05), int(440 * 0.97)], 0.55),
